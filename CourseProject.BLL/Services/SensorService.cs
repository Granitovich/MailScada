...
namespace CourseProject.BLL.Services
{
	public class SensorService : ISensorService
	{
		...
		public async Task<Guid> CreateSensor(SensorMailModel model)
		{
			var sensor = new SensorMail()
			{
		...
		public async Task<List<SensorMailModel>> GetSensors()
		{
			var sensors = await _context.Sensors.Include(i => i.SensorValues).ToListAsync();

			var sensorModels = sensors.Select(model => new SensorMailModel()
			{
				Id = model.Id,
				Description = model.Description,
				Value = model.Value,
		...
		public async Task UpdateSensorValue(UpdateMailModel model)
		{
